...
public class MainView {
	...
	//게시판 기능 메뉴 객체 생성
	private BoardView boradview = new BoardView();
			...
			try {
				...
				if(LoginMember == null) { //로그인 X
					...
					switch(input){
						...
						case 1:memberView.memberMenu(LoginMember);break;//1.회원기능 서브 메뉴출력
						case 2:BoardView.boardMenu(); break; //게시판기능 서브 메뉴 출력 
						case 0:
						LoginMember = null; //로그아웃 == loginMember 가 참조하는 객체 없음(== null )
						System.out.println("\n [로그아웃 되었습니다] \n" );
		...
		System.out.println("[회원 가입]");
		 ...
		 try {
			...
			while(true) {
				...
				if(memberPw.equals(memberPw2)) { //일치 할 경우
